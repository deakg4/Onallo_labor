clc
clear
filename = 'FreqRespForce_DP_0.txt'; % Fájlnév megadása

% T = fileread(filename); % txt beolvasása táblázat formátumba
% fileID = fopen(filename); % txt beolvasása táblázat formátumba
[A,delimiterOut,headerlinesOut] = importdata(filename);
A = importdata(filename, delimiterOut);
